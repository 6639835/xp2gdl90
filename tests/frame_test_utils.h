#ifndef XP2GDL90_TESTS_FRAME_TEST_UTILS_H
#define XP2GDL90_TESTS_FRAME_TEST_UTILS_H
...
inline std::vector<uint8_t> ExtractPayload(const std::vector<uint8_t>& message) {
...
#endif  // XP2GDL90_TESTS_FRAME_TEST_UTILS_H
